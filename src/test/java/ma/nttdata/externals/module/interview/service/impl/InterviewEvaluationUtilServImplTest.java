...
public class InterviewEvaluationUtilServImplTest {
    ...
    @Mock
    private PromptService promptServ;
    ...
    void should_return_saved_evaluations() throws Exception {
        ...
        InterviewEvaluationsRequestDTO interviewEvaluationsRequest =
                new InterviewEvaluationsRequestDTO("test",List.of(questionsAndAnswersForEvaluation1, questionsAndAnswersForEvaluation2));
        ...
        when(promptServ.findByPromptCode(interviewEvaluationsRequest.promptCode()))
                .thenReturn(prompt);
